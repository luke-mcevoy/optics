...
export default function Guide() {
  ...
  useEffect(() => {
    ...
    if (id.length > 0 && id !== 'guide' && !id.includes('/')) {
    ...
    <div className="page">
      <header className="masthead">
        ...
        <p className="mast-meta">
          <a href="#/instrument">inside the instrument</a> ·{' '}
          <a href="#/journey/0">interactive journey</a> ·{' '}
      ...
      <header className="hero">
        <div className="hero-inner">
          ...
          <a className="instrument-open" href="#/instrument">Inspect the complete optical table · follow the lasers into the atoms ↗</a>
